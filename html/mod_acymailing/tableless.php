...
$document->addScript('templates/'.$template.'/js/jquery.validate.min.js');
$document->addScript('templates/'.$template.'/js/additional-methods.min.js');
$document->addScriptdeclaration('(function($){$(document).ready(function(){$("#'.$formName.'").validate({wrapper:"mark",submitHandler:function(a){return submitacymailingform("optin","'.$formName.'")}})})})(jQuery);'); ?>
