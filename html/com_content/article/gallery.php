...
$doc->addStyleSheet('templates/'. $template->template.'/css/jquery.fancybox.css');
		...
		$doc->addStyleSheet('templates/'. $template->template .'/css/portfolio.css');
...
?>
<article class="page-item 1111 page-item__gallery page-item__<?php echo $this->pageclass_sfx?>">
	<?php 
