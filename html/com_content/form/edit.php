...
JFactory::getDocument()->addScriptdeclaration('Joomla.submitbutton=function(task){if(task=="article.cancel"||document.formvalidator.isValid(document.getElementById("adminForm"))){'.$this->form->getField("articletext")->save().'Joomla.submitform(task)}};jQuery(document).bind("ready",function(){jQuery(".media-preview.add-on").addClass("btn").removeClass("media-preview")});'); ?>
