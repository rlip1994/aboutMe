...
<div class="mod-newsflash-adv mod-newsflash-adv__<?php echo $moduleclass_sfx; ?> cols-<?php echo $columns; ?>" id="module_<?php echo $module->id; ?>">
  ...
  ?>
  <article class="<?php echo $spanClass; ?> item item_num<?php echo $i; ?> item__module  <?php echo $class; ?>" id="item_<?php echo $item->id.'_'.$module->id; ?>">
    <?php require JModuleHelper::getLayoutPath('mod_articles_news_adv', '_title-img-intro'); ?>
  </article>
  <?php endfor; ?>
  </div> 
