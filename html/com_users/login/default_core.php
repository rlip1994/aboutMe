...
<fieldset id="users-profile-core">
  <<?php echo $template->params->get('categoryPageHeading', 'h3'); ?>><?php echo $this->escape(JText::_('COM_USERS_PROFILE_CORE_LEGEND')); ?></<?php echo $template->params->get('categoryPageHeading', 'h3'); ?>>
	<dl class="dl-horizontal">
		...
		<dd><?php echo JHtml::_('date', $this->user->registerDate); ?></dd>
		<dt><?php echo JText::_('COM_USERS_PROFILE_LAST_VISITED_DATE_LABEL'); ?></dt>
		<?php if ($this->data->lastvisitDate != '0000-00-00 00:00:00'){?>
		<dd><?php echo JHtml::_('date', $this->user->lastvisitDate); ?></dd>
		<?php }
		else
		{?>
