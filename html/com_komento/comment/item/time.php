...
<span class="kmt-time">
	...
	if( $system->config->get( 'datetime_permalink' ) ) { ?>
		<a class="kmt-timepermalink" href="<?php echo $row->permalink; ?>" alt="<?php echo JText::_( 'COM_KOMENTO_COMMENT_PERMALINK' ); ?>"<?php if( $system->konfig->get( 'enable_schema' ) ) echo 'itemprop="url"'; ?>>
	<?php }
	echo $row->created;
	if( $system->config->get( 'datetime_permalink' ) ) { ?>
		</a>
